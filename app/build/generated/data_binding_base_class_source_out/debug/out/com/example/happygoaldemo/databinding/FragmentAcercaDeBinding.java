...
public final class FragmentAcercaDeBinding implements ViewBinding {
  ...
  private FragmentAcercaDeBinding(@NonNull FrameLayout rootView) {
  ...
  public static FragmentAcercaDeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_acerca_de, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static FragmentAcercaDeBinding bind(@NonNull View rootView) {
    ...
    return new FragmentAcercaDeBinding((FrameLayout) rootView);
  }
}
